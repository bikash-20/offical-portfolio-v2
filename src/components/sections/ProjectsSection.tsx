              ...
              >
                ...
                <div className="flex flex-col gap-4 border-b border-[#D7E2EA]/15 pb-4 sm:flex-row sm:items-end sm:justify-between md:pb-6">
                  <div className="flex items-end gap-4 sm:gap-8">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <h3 className="text-[clamp(1.1rem,2.4vw,2.4rem)] font-medium uppercase leading-tight text-[#D7E2EA]">
                        {p.name}
                      </h3>
                    </div>
                  </div>
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    {p.live && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 rounded-full border-2 border-[#D7E2EA] px-4 py-2 text-xs font-medium uppercase tracking-widest text-[#D7E2EA] transition-colors duration-200 hover:bg-[#D7E2EA]/10 sm:px-6 sm:py-2.5 sm:text-sm"
                      >
                    ...
                    {p.repo && (
                      <a
                        ...
                        className="grid h-10 w-10 place-items-center rounded-full border-2 border-[#D7E2EA]/40 text-[#D7E2EA] transition-colors duration-200 hover:border-[#D7E2EA] hover:bg-[#D7E2EA]/10"
                      >
                ...
                <div className="relative mt-4 flex-1 overflow-hidden rounded-[28px] sm:mt-6 sm:rounded-[36px] md:rounded-[48px]">
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#0C0C0C] via-[#0C0C0C]/70 to-transparent p-5 sm:p-8">
                    <p className="max-w-3xl text-sm font-light leading-relaxed text-[#D7E2EA]/90 sm:text-base md:text-lg">
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {p.tech.map((t) => (
                        <span
                          key={t}
                          className="rounded-full border border-[#D7E2EA]/30 bg-[#0C0C0C]/50 px-2.5 py-0.5 text-[10px] font-medium uppercase tracking-widest text-[#D7E2EA]/90 backdrop-blur"
                        >
                          {t}
                        </span>
                      ))}
